...
[32m+[m[32m]},{tag:'div',cls:'btn-group roo-upload-cropbox-rotate-right',action:'rotate-right',cn:[{tag:'button',cls:'btn btn-default',html:'<i class="fa fa-repeat"></i>'}]}]}});[m
  ...
  delete[m
  github[m
  github.com.roojs1.master[m
  gitlive[m
  master[m
  wip_alan_T5622_fix_roojs_dynamic_example[m
  wip_alan_T5635_chome_extension_for_uploading_clippings[m
  wip_alan_T5654_roojspacker_get_it_working_as[m
  wip_alan_T5657_Summary_page_for_documentation[m
  wip_alan_T5660_roojs_docs_linking_and_other[m
  wip_alan_T5665_precommit_hooks_for_roojs[m
  wip_alan_T5678_tidy_up_roojs_directory[m
  wip_alan_T5681_fix_bootstrap4_detection[m
  wip_alan_T5747_combo_pulldown_issue[m
  wip_alan_T5750_roo_library_dynamic_components[m
  wip_alan_T5829_Messing_around_with_flutter_API[m
  wip_alan_T5925_minimal_bootstrap_for_alerts[m
  wip_alan_T5944_trim_leading_white_space_from[m
  wip_alan_T5946_fix_defaults_on_js_breaks[m
  wip_alan_T5956_handle_file_input_with_stripping[m
  wip_alan_T5963_white_space_strip_only_on[m
  wip_alan_T6011_fixing_surrogate_characters[m
  wip_alan_T6045_use_formdata_to_handle_forms[m
  wip_alan_T6048_clean_up_hanging_span_content[m
  wip_alan_T6102_issue_with_word_clean[m
  wip_alan_T6141_super_script_and_subscribe[m
  wip_alan_T6201_Category_select[m
  wip_alan_T6293_support_for_adding_columns[m
  wip_alan_T6384_See_if_we_can_get[m
  wip_alan_T6430_messing_arouds_with_cards_BS4[m
  wip_alan_T6433_fine_tuning_tests_for_cards[m
  wip_alan_T6464_card_header[m
  wip_alan_T6465_drag_drop_for_cards[m
  wip_alan_T6495_add_ticket_testing[m
  wip_alan_T6524_test_client_access[m
  wip_alan_T6584_make_popover_a_primary_container[m
  wip_alan_T6593_time_picker_tester[m
  wip_alan_T6596_lightbox_on_images[m
  wip_alan_T6597_Popover_api_improvements[m
  wip_alan_T6625_undo_reset[m
  wip_alan_T6630_making_upload_work_with_card[m
  wip_alan_T6637_more_image_tiy_up_on[m
  wip_alan_T6640_Inspection_Schedule[m
  wip_alan_T6641_add_events_for_handling_view[m
  wip_alan_T6652_pass_gridview_events_into_grid[m
  wip_alan_T6662_support_header_image_in_square[m
  wip_alan_T6666_paging_upgrade_to_bs4[m
  wip_alan_T6673_mobile_cards_issues[m
  wip_alan_T6696_Document_Browse[m
  wip_alan_T6709_default_widths_on_input_fields[m
  wip_alan_T6790_Upload_Button[m
  wip_alan_T6814_Notification_fadeout[m
  wip_alan_T6833_print_layer_map[m
  wip_alan_T6842_svg_handling[m
  wip_alan_T6852_svg_support_for_domquery_gettarget[m
  wip_alan_T6864_dynamicall_adding_columns[m
  wip_alan_T6874_Grid_column_resize[m
  wip_alan_T6883_image_loading_tidy_up[m
  wip_alan_T6893_fix_roo_docs[m
  wip_alan_T6901_CRM_allow_comments_in_HTML[m
  wip_alan_T6904_JSON_output_for_docs_editor[m
  wip_alan_T6912_issue_with_parsing_RoolibDom[m
  wip_alan_T6913_add_more_documentation_to_code[m
  wip_alan_T6922_replace_builder_to_with_parent[m
  wip_alan_T6962_html_editor_update_to_new[m
  wip_alan_T7151_parse_block_for_figure[m
  wip_alan_T7160_sort_out_comment_removal_and[m
  wip_alan_T7162_warnings_on_files[m
  wip_alan_T7189_simplify_array_grid_example[m
  wip_alan_T7197_fix_form_layout_files_and[m
  wip_alan_T7275_handling_odd_word_document[m
  wip_alan_T7284_more_issues_with_bullet_point[m
  wip_alan_T7295_a_name_tags_in_word[m
  wip_alan_T7300_namespace_cleaning_on_word[m
  wip_edward_T5642_Report_designer_hebe[m
  wip_edward_T5655_UAT_of_Press_release_detail[m
  wip_edward_T5718_Change_the_order_layout_of[m
  wip_edward_T5720_Order_Discount_Penalty_new_tab[m
  wip_edward_T5765_masking_for_missing_entries[m
  wip_edward_T5791_Search_Criteria_on_Orders_Columns[m
  wip_edward_T5820_Load_times_of_country_tree[m
  wip_edward_T5859_Fw_Fw_Text_sticking_together[m
* [32mwip_leon_T7094_logo_image_upload_in_boilerplate[m
  wip_leon_T7199_adding_images_to_bolierplates[m
  wip_leon_T7207_html_editor_clean_word_button[m
  wip_leon_T7281_table_editing_widths_doent_work[m
