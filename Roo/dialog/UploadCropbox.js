...
Roo.extend(Roo.dialog.UploadCropbox, Roo.Component,  {
    ...
    {   
        ...
        if(center) {
            ...
            console.log("old canvas height: " + this.imageEl.OriginWidth * this.baseScaleLevel() * Math.pow(1.02, this.startScale));
            console.log("old canvas height: " + this.imageEl.OriginHeight * this.baseScaleLevel() * Math.pow(1.02, this.startScale));
            this.previewEl.setLeft(pw);
            this.previewEl.setTop(ph);
        }
    ...
    zoomable : function()
    {
        ...
        if(
                ...
                (this.rotate == 0 || this.rotate == 180) && 
                (
                    (this.imageEl.OriginWidth / this.imageEl.OriginHeight >= this.minWidth / this.minHeight) && width < this.minWidth * 0.9 ||
                    (this.imageEl.OriginWidth / this.imageEl.OriginHeight <= this.minWidth / this.minHeight) && height < this.minHeight * 0.9 ||
                    width > maxWidth ||
                    height > maxHeight
                )
        ){
