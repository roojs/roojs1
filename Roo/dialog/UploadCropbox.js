...
Roo.extend(Roo.dialog.UploadCropbox, Roo.Component,  {
    ...
    {   
        ...
        var maxPaddingLeft = this.canvasEl.width * 0.05;
        var maxPaddingTop = this.canvasEl.height * this.minHeight / this.minWidth * 0.05;
    ...
    zoomable : function()
    {
        ...
        var maxPaddingTop = newCanvasHeight * this.minHeight / this.minWidth * 0.05;
