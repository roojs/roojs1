...
Roo.extend(Roo.dialog.UploadCropbox, Roo.Component,  {
    ...
    zoomable : function()
    {
        ...
        var maxPaddingLeft = newCanvasWidth > newCanvasHeight ? newCanvasWidth * 0.05 : newCanvasHeight * 0.05;
        ...
        if ((this.imageEl.OriginWidth / this.imageEl.OriginHeight >= this.minWidth / this.minHeight)) {
            maxPaddingTop = Math.ceil((newCanvasWidth * this.minHeight / this.minWidth - newCanvasHeight) / 2 + maxPaddingLeft);
        }
        ...
        Roo.log("scale level: " + this.imageEl.OriginHeight * this.getScaleLevel());
