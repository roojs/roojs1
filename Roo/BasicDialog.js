...
Roo.extend(Roo.BasicDialog, Roo.util.Observable, {
     ...
     * @return {Roo.panel.Tree} The tabs component
     */
    initTabs : function(){
    ...
    /**
     * Returns the panel.Tree component (creates it if it doesn't exist).
    ...
    getTabs : function(){
        if(!this.tabs){
            ...
            this.tabs = new Roo.panel.Tree(this.body.dom, this.tabPosition == "bottom");
        }
        return this.tabs;
    },
