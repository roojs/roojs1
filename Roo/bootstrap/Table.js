...
//        this.maskEl.show();
        ...
        var mark = {
            ...
            cn: [
                {
                    tag: "div",
                    style: "background-color:white;width:50%;margin:10 auto",
                    cn: [
                        {
                            tag: "img",
        ...
        Roo.log('run!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1');
        Roo.log(this.el.getCenterXY());
        Roo.log(this.parent().el.getCenterXY());
        Roo.log(this.el.getBox());
        Roo.log(this.parent().el.getBox());
        Roo.log(this.parent());
        Roo.log(mark);
        ...
        this.maskEl.setTop(this.el.getTop());
        this.maskEl.setLeft(this.el.getLeft());
        this.maskEl.enableDisplayMode("block");
        this.maskEl.show();
        if(!this.loadMask){
//            this.maskEl.hide();
