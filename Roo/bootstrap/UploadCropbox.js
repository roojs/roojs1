...
//                }
//                
//                Roo.log([minWidth, minHeight]);
//                
//                Roo.log(scale);
//                if(height != minHeight && height * scale > minHeight){
//                    Roo.log(height * scale);
...
//                }
                ...
                context.scale(targetWidth / width, targetHeight / height);
            ...
            case 90 : 
                ...
                if(width < height){
                    scale = Math.max(((this.minWidth - 2 * x) / width), ((this.minHeight - 2 * y) / height));
                }
