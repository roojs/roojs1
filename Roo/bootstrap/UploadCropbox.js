...
Roo.extend(Roo.bootstrap.UploadCropbox, Roo.bootstrap.Component,  {
    ...
    crop : function()
    {
        ...
        imageContext.drawImage(this.imageEl, 0, 0, this.imageEl.OriginWidth, this.imageEl.OriginHeight, 0, 0, imageCanvas.width, imageCanvas.height);
        ...
        context.drawImage(this.imageEl, x, y, this.imageEl.OriginWidth, this.imageEl.OriginHeight, centerX * -1, centerY * -1, canvas.width, canvas.height);
