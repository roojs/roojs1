    ...
    crop : function()
    {
        ...
        switch (this.rotate) {
            case 0 :
                ...
                Roo.log([this.thumbEl.getWidth() / this.canvasEl.width, this.thumbEl.getHeight() / this.canvasEl.height]);
                
                Roo.log([this.canvasEl.width / this.thumbEl.getWidth(), this.canvasEl.height / this.thumbEl.getHeight()]);
