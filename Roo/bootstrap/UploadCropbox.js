...
//        alert(baseRotateLevel);
        ...
        context.drawImage(this.image.dom, 0, 0, this.image.OriginWidth, this.image.OriginHeight, centerX * -1, centerY * -1, this.image.OriginWidth, this.image.OriginHeight);;
