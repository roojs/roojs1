...
Roo.extend(Roo.bootstrap.UploadCropbox, Roo.bootstrap.Component,  {
    ...
    {   
        var pw = Math.ceil((this.imageSection.getWidth(true) - this.image.getWidth()) / 2);
        var ph = Math.ceil((this.imageSection.getHeight(true) - this.image.getHeight()) / 2);
...
//        alert(JSON.stringify(Roo.apply({}, canvas.getBoundingClientRect())));
        ...
        context.drawImage(this.image.dom, 50, y, cropWidth, cropHeight, centerX * -1, centerY * -1, canvas.width, canvas.height);
