    ...
    crop : function()
    {
        ...
        switch (this.rotate) {
            case 0 :
                ...
                Roo.log([this.thumbEl.getWidth() / this.canvas.width, this.thumbEl.getHeight() / this.canvas.height]);
                
                Roo.log([this.canvas.width / this.thumbEl.getWidth(), this.canvas.height / this.thumbEl.getHeight()]);
