...
Roo.apply(Roo.bootstrap.Form, {
    ...
    popover : {
        ...
        apply : function()
        {
            ...
            this.maskEl.left.enableDisplayMode("block").setStyle('position', 'fixed');
            this.maskEl.bottom.enableDisplayMode("block").setStyle('position', 'fixed');
            this.maskEl.right.enableDisplayMode("block").setStyle('position', 'fixed');
        ...
        mask : function(form, target)
        {
            ...
            window.onwheel = function(){ return false;};
                ...
                Roo.log(['bottom', 0, box.bottom + this.padding])
