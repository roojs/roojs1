...
Roo.apply(Roo.bootstrap.Form, {
    ...
    popover : {
        ...
        mask : function(form, target)
        {
            ...
            this.maskEl.left.setTop(box.right);
            this.maskEl.left.setLeft(this.padding, box.y - this.padding);
            ...
            this.maskEl.bottom.setTop(0);
            this.maskEl.bottom.setLeft(box.bottom + this.padding);
            ...
            this.maskEl.right.setTop(0);
            this.maskEl.right.setLeft(box.y - this.padding);
