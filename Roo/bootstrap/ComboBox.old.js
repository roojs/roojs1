/*
 * - LGPL THIS IS THE OLD CLASS, SHOULD NOT USE ANYMORE
 * * 
 */
 ...
 */
Roo.bootstrap.ComboBox_old = function(config){
    Roo.bootstrap.ComboBox_old.superclass.constructor.call(this, config);
    this.addEvents({
        /**
         * @event expand
...
Roo.extend(Roo.bootstrap.ComboBox_old, Roo.bootstrap.TriggerField, {
    ...
    initEvents: function(){
        ...
        Roo.bootstrap.ComboBox_old.superclass.initEvents.call(this);
...
//                this.onViewClick();
    ...
    onDestroy : function(){
        ...
        Roo.bootstrap.ComboBox_old.superclass.onDestroy.call(this);
    },
...
//        Roo.bootstrap.ComboBox_old.superclass.onResize.apply(this, arguments);
//        
//        if(typeof w != 'number'){
//            // we do not handle it!?!?
//            return;
...
//        }
    ...
    getValue : function(){
        ...
        if(this.valueField){
            ...
            return Roo.bootstrap.ComboBox_old.superclass.getValue.call(this);
        }
    },
    ...
    setValue : function(v){
        ...
        Roo.bootstrap.ComboBox_old.superclass.setValue.call(this, text);
        this.value = v;
    },
    /**
    ...
    setFromData : function(o){
        ...
        if(this.hiddenField){
            ...
            Roo.bootstrap.ComboBox_old.superclass.setValue.call(this, dv);
            this.value = vv;
            return;
        }
