...
//        this.list = this.el.select('ul.dropdown-menu',true).first();
    ...
    onTouchDeviceClick : function(e, el)
    {
        ...
        this.touchViewBodyEl.setSize( this.touchViewBodyEl.getWidth(),Roo.lib.Dom.getViewHeight(true) - this.touchViewHeaderEl.getHeight() - this.touchViewFooterEl.getHeight());
        
        Roo.log([Roo.lib.Dom.getViewHeight(true), this.touchViewHeaderEl.getHeight(), this.touchViewFooterEl.getHeight()])
