...
//        this.footer = this.list.createChild({cls:cls+'-ft'});
        ...
        if(!this.tpl){
            this.tpl = '<li class="select2-result"><div class="checkbox"><input id="{roo-id}" type="checkbox"><label for="{roo-id}"><b>{' + this.displayField + '}</b></label></li>';
        }
...
//                    this.expand();
    ...
    onViewScroll : function(e, t){
        ...
        if(this.view.el.getScroll().top < this.view.el.dom.scrollHeight - this.view.el.dom.clientHeight || !this.hasFocus || !this.append || this.hasQuery || this.tickable){
            return;
        }
