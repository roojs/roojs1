    ...
    */
    _processLayoutQueue : function( queue, isInstant )
    {
        ...
        Roo.each(queue, function(block, k){
            ...
            var columnWidth = this.colWidth - (gutter * this.gutterWidth);
...
//        var containerWidth = this.containerWidth - this.padWidth;
        ...
        var totalColWidth = this.cols * (this.columnWidth + this.padWidth);
        
        var avail = Math.floor((containerWidth - totalColWidth - this.padWidth * this.cols) / this.cols);
