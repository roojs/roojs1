...
Roo.extend(Roo.bootstrap.LayoutMasonry, Roo.bootstrap.Component,  {
    ...
    */
    ...
    _processHorizontalLayoutQueue : function( items, eItems, isInstant )
    {
        var pos = this.el.getBox(true);
    ...
    _processHorizontalEndItem : function(eItems, maxX, y, maxY, isInstant)
    {
    ...
    horizontalMeasureColumns : function()
    {
        ...
        var xsWidth = Math.floor((this.boxColWidth - (this.gutter * 2)) / 3);
