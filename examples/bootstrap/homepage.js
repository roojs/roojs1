...
homepage = new Roo.XComponent({
 ...
 _strings : {
  ...
  '25d3bc8aaa2306df70a61938535634dc' :"<a class=\"btn btn-primary btn-large\">Learn more »</a>",
      ...
      },
      {
       ...
       items  : [
        ...
        },
        {
         xtype : 'Element',
         cls : 'text-right',
         html : _this._strings['25d3bc8aaa2306df70a61938535634dc'] /* <a class="btn btn-primary btn-large">Learn more »</a> */,
         tag : 'p',
         xns : Roo.bootstrap,
         '|xns' : 'Roo.bootstrap'
        }
