...
Roo.onReady(function(){
    var ds = new Roo.data.Store({
        proxy: new Roo.data.ScriptTagProxy({
            url: 'http://www.roojs.com/trac/timeline?ticket=on&changeset=on&milestone=on&wiki=on&max=50&daysback=90&format=rss'
        }),
    ...
    var view = new Roo.View('search-results', resultTpl, {store: ds});

    var tb = new Roo.Toolbar('search-tb', [
        'Search: ', ' ',
        new Roo.app.SearchField({
            store: ds,
            width:320
        })
    ]);

    new Roo.PagingToolbar('page-tb', ds, {
        pageSize: 20,
        displayInfo: true,
...
Roo.app.SearchField = Roo.extend(Roo.form.TwinTriggerField, {
    initComponent : function(){
        Roo.app.SearchField.superclass.initComponent.call(this);
