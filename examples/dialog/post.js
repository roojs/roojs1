...
var Comments = function(){
    ...
    return {
        init : function(){
             ...
             txtComment = Roo.get('comment');
             commentsList = Roo.get('comments-list');
             postLink = Roo.get('post-comment');
             viewLink = Roo.get('view-comments');
             wait = Roo.get('post-wait');
             error = Roo.get('post-error');
             errorMsg = Roo.get('post-error-msg');
        ...
        submitComment : function(){
            ...
            Roo.lib.Ajax.formRequest('comment-form', 'post.php',
                    {success: commentSuccess, failure: commentFailure});          
        },
        
        createDialog : function(){
            dialog = new Roo.BasicDialog("comments-dlg", { 
                    autoTabs:true,
                    width:500,
                    height:300,
                    shadow:true,
...
var CommentRenderer = function(list){
    ...
    var tpl = new Roo.DomHelper.Template(
          '<li id="comment-{id}">' +
          '<div class="cheader">' +
